...
let sessions = {}; 
// { sessionId: { sessionName, expiresAt, whatsappLink, contacts: [] } }
...
app.post("/api/session", (req, res) => {
  ...
  res.json({
    ...
    sessionId,
    // 👇 Correct: Send user to upload.html with ?sid=...
    uploadPage: `${baseUrl}/create.html?sid=${sessionId}`, 
    // 👇 Correct: Session creation/admin page
    adminPage: `${baseUrl}/session.html?sid=${sessionId}`
  });
});
